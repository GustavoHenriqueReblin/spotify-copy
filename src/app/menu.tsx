            ...
            <nav className="bg-zinc-900 w-full h-[calc(100%-7.5rem)] mt-2 rounded-lg">
                ...
                <div className="w-full h-[calc(100%-7rem)] mt-0.5 py-1">
                    <div className="w-full h-full m-0">
                        <div id="playlists" onScroll={() => AppHelper.changePlaylistsShadow()} className="overflow-y-auto h-full">
                            <div className="h-8 w-full flex flex-row my-1 mb-2.5">
                                ...
                                <div className="h-full w-full pr-3">
                                    <a id="orderByBtn" onClick={() => AppHelper.orderByClick()} className="flex flex-row justify-end items-center text-sm cursor-pointer"> Recentes
